...
if(isset($_POST['btnchange']))
{
	...
	$selquery="select * from tbl_makeupstudio where studio_password='".$oldpassword."' and studio_id='".$_SESSION['sid']."'";
	$res=$con->query($selquery);
	if($data=$res->fetch_assoc())
	{
		if($newpassword==$confirmpassword)
		{
			$updatequery="update tbl_makeupstudio set studio_password='".$newpassword."' where studio_id='".$_SESSION['sid']."'";
