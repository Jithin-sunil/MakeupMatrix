...
if(isset($_POST["btnsubmit"]))
{
		...
		$insQry="insert into tbl_complaint(complaint_date,complaint_content,studio_id)values(curdate(),'".$content."','".$_SESSION["sid"]."')";
...
<p>&nbsp;</p>
  <?php
  $selQry="select * from tbl_complaint where studio_id=".$_SESSION['sid'];
