...
<html lang="en">
  <head>
    <title>The Makeup Matrix &mdash;</title>
    <meta charset="utf-8">
    ...
    <div class="site-navbar bg-white py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          <div class="logo">
            <div class="site-logo">
              <a href="Homepage.php" class="js-logo-clone">The Makeup Matrix</a>
            </div>
          </div>
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li><a href="ViewServiceBooking.php">View ServiceBooking</a></li>
                <li><a href="Complaint.php">Complaints</a></li>
              </ul>
            </nav>
          </div>
          <div class="icons">
            <a href="../Logout.php" class="icons-btn d-inline-block "><i class="fa-sharp fa-solid fa-right-from-bracket"></i></a>
